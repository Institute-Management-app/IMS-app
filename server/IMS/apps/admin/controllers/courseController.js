...
module.exports.create = async (req, res) => {
    const {course_name, department, semester, fees} = req.body;
    try {
...
module.exports.getOne = async (req, res) => {
    ...
    try {
        ...
        if (!course) {
            return res.status(404).json(new ResponseModel(null, null, ["Course not found"]));
        }
...
module.exports.update = async (req, res) => {
    ...
    try {
        ...
        res.status(500).json(new ResponseModel(null, null, ["Unable to update data"]));
    }
}
